...
\begin{lstlisting}[language=yaml, caption={Blue-Green con Docker Compose}]
...
\begin{lstlisting}[language=yaml, caption={Canary Release - Traffic Splitting}]
...
\begin{lstlisting}[language=yaml, caption={Stack Multi-Service Production}]
...
\begin{lstlisting}[language=yaml, caption={Production Deployment con Kubernetes}]
# deployment.yaml
apiVersion: apps/v1
kind: Deployment
metadata:
...
\begin{lstlisting}[language=yaml, caption={Service Types}]
...
\begin{lstlisting}[language=yaml, caption={ArgoCD Application}]
