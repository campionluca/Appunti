...
\begin{lstlisting}[, caption=docker-compose.yml per registry]
version: '3.8'
...
\begin{lstlisting}[, caption=.github/workflows/docker.yml]
...
\begin{lstlisting}[, caption=.gitlab-ci.yml]
variables:
...
\begin{lstlisting}[, caption=Registry webhook config]
# /etc/docker/registry/config.yml
notifications:
  endpoints:
    - name: slack
...
\begin{lstlisting}[, caption=Production-grade registry stack]
version: '3.8'
