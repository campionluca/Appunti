...
\begin{lstlisting}[language=yaml, caption={GitHub Actions - Complete Production Pipeline}]
...
\begin{lstlisting}[language=yaml, caption={.gitlab-ci.yml - Enterprise Pipeline}]
# .gitlab-ci.yml
variables:
...
\begin{lstlisting}[language=docker, caption={Optimized Multi-Stage Build}]
...
\begin{lstlisting}[language=yaml, caption={docker-compose.test.yml}]
version: '3.8'
...
\begin{lstlisting}[language=yaml, caption={GitHub Actions Matrix Testing}]
...
\begin{lstlisting}[language=yaml, caption={GitLab CI with HashiCorp Vault}]
