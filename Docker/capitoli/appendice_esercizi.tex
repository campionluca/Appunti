...
\begin{lstlisting}[, caption={microservices/docker-compose.yml}]
version: '3.8'
...
\begin{lstlisting}[, caption={wordpress/docker-compose.yml}]
version: '3.8'
...
\begin{lstlisting}[, caption={airflow/docker-compose.yml}]
version: '3.8'
