...
La programmazione funzionale tratta le funzioni come cittadini di prima classe (first-class citizens), permettendo di:
\begin{itemize}
    \item Passare funzioni come parametri
    \item Restituire funzioni come valori di ritorno
    \item Assegnare funzioni a variabili
\end{itemize}
