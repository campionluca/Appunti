...
\begin{itemize}
  \item Raccogliere dati dagli utenti (registrazione, login, contatti)
  \item Effettuare ricerche
  \item Caricare file
  \item Inviare feedback o commenti
  \item Completare transazioni (acquisti, prenotazioni)
  \item Configurare preferenze
\end{itemize}
