...
La specificity si rappresenta come una tupla $(a, b, c, d)$ dove:

\begin{itemize}
    \item \textbf{a}: numero di inline styles (\texttt{style="..."})
    \item \textbf{b}: numero di ID selectors (\texttt{\#id})
    \item \textbf{c}: numero di class selectors, attribute selectors, pseudo-classes
    \item \textbf{d}: numero di element selectors, pseudo-elements
\end{itemize}
