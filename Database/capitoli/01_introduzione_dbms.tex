...
\begin{itemize}
    \item Memorizzare dati in modo organizzato e persistente
    \item Recuperare dati efficientemente
    \item Aggiornare dati mantenendo la coerenza
    \item Controllare l'accesso ai dati
    \item Proteggere i dati da accessi non autorizzati
\end{itemize}
...
\begin{itemize}
    \item Un \textbf{DBMS} centralizza e gestisce i dati di un'organizzazione
    \item Le proprietà \textbf{ACID} garantiscono transazioni affidabili
    \item L'\textbf{atomicità} garantisce tutto-o-nulla
    \item La \textbf{coerenza} mantiene l'integrità dei vincoli
    \item L'\textbf{isolamento} separa le transazioni concorrenti
    \item La \textbf{durabilità} rende i dati permanenti
\end{itemize}
\end{tcolorbox}
