...
\textbf{Colori:}
\begin{itemize}
    \item BIANCO: Non ancora scoperto
    \item GRIGIO: Scoperto ma non completamente esplorato
    \item NERO: Completamente esplorato
\end{itemize}
...
\textbf{Applicazioni di BFS:}
\begin{itemize}
    \item Trovare il cammino più breve (non pesato)
    \item Testare se un grafo è connesso
    \item Trovare componenti connesse
    \item Testare se un grafo è bipartito
    \item Web crawling
    \item Sistemi di raccomandazione (amici di amici)
\end{itemize}
...
\textbf{Applicazioni di DFS:}
\begin{itemize}
    \item Rilevazione di cicli
    \item Ordinamento topologico
    \item Componenti fortemente connesse
    \item Risoluzione di labirinti
    \item Analisi di dipendenze
\end{itemize}
