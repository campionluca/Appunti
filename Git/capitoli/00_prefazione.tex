...
\begin{itemize}
    \item Permette di tracciare ogni modifica al codice nel tempo
    \item Facilita la collaborazione tra team distribuiti geograficamente
    \item Abilita workflow complessi di sviluppo (feature branches, hotfix, release)
    \item Fornisce sicurezza contro perdite di dati e regressioni
    \item È richiesto praticamente da ogni azienda tech nel mondo
\end{itemize}
...
\begin{itemize}
    \item Familiarità con la riga di comando (terminal/bash/cmd)
    \item Conoscenza base di un linguaggio di programmazione
    \item Comprensione dei concetti di file e directory
    \item (Opzionale) Esperienza con sviluppo software collaborativo
\end{itemize}
