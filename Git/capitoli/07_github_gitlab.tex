...
Le issues sono il sistema di ticket di GitHub e GitLab per tracciare e coordinare il lavoro del progetto. Vengono usate per bug reports quando qualcosa non funziona, feature requests quando è necessario aggiungere nuova funzionalità, domande e discussioni sullo sviluppo, e to-do list per organizzare il lavoro che il team deve completare.
