...
\begin{itemize}
    \item \textbf{Strumenti base}: wc, cut, sort, uniq per operazioni semplici
    \item \textbf{sed}: editing stream, sostituzioni, trasformazioni
    \item \textbf{awk}: linguaggio completo per text processing
    \item \textbf{Combinazioni}: pipe per operazioni complesse
    \item \textbf{Pattern pratici}: analisi log, CSV processing, reporting
\end{itemize}
...
\begin{itemize}
    \item Navigare e gestire il filesystem
    \item Controllare permessi e ownership
    \item Gestire processi e risorse
    \item Scrivere script Bash complessi
    \item Processare e analizzare file di testo
\end{itemize}
