...
\begin{itemize}
    \item \textbf{Script base}: shebang, esecuzione, commenti
    \item \textbf{Variabili}: definizione, tipi, espansione
    \item \textbf{I/O}: echo, printf, read, redirezioni
    \item \textbf{Condizionali}: if-then-else, test conditions, case
    \item \textbf{Loop}: for, while, until, break, continue
    \item \textbf{Funzioni}: definizione, parametri, return values
    \item \textbf{Array}: indicizzati e associativi
\end{itemize}
