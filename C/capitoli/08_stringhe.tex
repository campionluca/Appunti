...
\begin{itemize}
    \item Array di caratteri con terminatore null
    \item Il terminatore \texttt{'\textbackslash 0'} marca la fine della stringa
    \item La dimensione dell'array deve includere spazio per il terminatore
    \item Possono essere manipolate come array o tramite puntatori
\end{itemize}
