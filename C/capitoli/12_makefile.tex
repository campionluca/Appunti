...
\begin{itemize}
    \item Automatizzare comandi di compilazione complessi
    \item Gestire dipendenze tra file oggetto e sorgenti
    \item Compilare solo i file modificati
    \item Executare test e pulizia automaticamente
    \item Rendere il progetto portabile e facile da distribuire
\end{itemize}
...
\begin{enumerate}
    \item \textbf{target}: il nome del file o dell'azione da creare
    \item \textbf{dipendenze}: file da cui dipende il target
    \item \textbf{comandi}: comandi da eseguire (con tabulazione iniziale)
\end{enumerate}
