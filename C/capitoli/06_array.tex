...
\begin{itemize}
    ...
    \item Gli elementi sono indicizzati a partire da 0
    \item La dimensione è fissa (definita alla creazione)
    \item Gli elementi sono memorizzati in memoria contigua
\end{itemize}
