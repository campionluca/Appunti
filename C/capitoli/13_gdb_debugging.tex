...
\begin{itemize}
    \item Eseguire il programma passo dopo passo
    \item Impostare breakpoint per fermare l'esecuzione in punti specifici
    \item Ispezionare il valore delle variabili durante l'esecuzione
    \item Visualizzare lo stack di chiamate (call stack)
    \item Modificare il comportamento del programma al volo
    \item Rilevare errori di memoria e segmentation fault
\end{itemize}
...
Il flag \texttt{-g} include informazioni di debugging:
\begin{itemize}
    \item Nomi di funzioni e variabili
    \item Numeri di linea del sorgente
    \item Tipi di dati
    \item Path ai file sorgenti
\end{itemize}
