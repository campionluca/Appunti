...
\begin{description}
    \item[Nome] Identificatore univoco (es. \texttt{eta}, \texttt{altezza})
    \item[Tipo] Determina quali valori può contenere (es. intero, decimale)
    \item[Valore] Il dato effettivamente memorizzato
\end{description}
